...
<head>
	...
	<title>dash.js Source: streaming/vo/HttpLoaderRequest.js</title>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h1 class="page-title">Source: streaming/vo/HttpLoaderRequest.js</h1>
    
<section>
    <article>
        <pre
            class="sunlight-highlight-javascript linenums">class HttpLoaderRequest {
    constructor(params) {
        /**
         * Request URL
         */
