...
`)},M1=(e,t=!0)=>n=>(t&&B1(e),n.env.isDebug&&c.info("Options:",e),K(n,{id:"hope"}),{name:C,define:A1(e,t),extendsBundlerOptions:(o,i)=>{e?.components?.includes("VidStack")&&R(o,i,/^media-/),G(o,i,["@vuepress/helper","vuepress-shared"])},clientConfigFile:o=>E1(o,e,t)});export{B as AVAILABLE_SERVICES,h as SHARE_CONFIG,A as backToTopLocales,M1 as componentsPlugin,E as pdfLocaleConfig,M as siteInfoLocaleConfig};
