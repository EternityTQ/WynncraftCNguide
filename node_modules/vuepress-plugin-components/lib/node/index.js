...
`)},Le=(e,t=!0)=>n=>(t&&xe(e),n.env.isDebug&&r.info("Options:",e),$(n,{id:"hope"}),{name:A,define:Ee(e),extendsBundlerOptions:(a,s)=>{e?.components?.includes("ArtPlayer")&&K(a,s,"artplayer"),e?.components?.includes("FontIcon")&&b(a,s,"iconify-icon"),e?.components?.includes("VidStack")&&b(a,s,/^media-/),_(a,s,["@vuepress/helper","vuepress-shared"])},clientConfigFile:a=>Be(a,e)});export{x as AVAILABLE_SERVICES,c as SHARE_CONFIG,Le as componentsPlugin,E as pdfLocaleConfig,B as siteInfoLocaleConfig,L as vidstackLocales};
