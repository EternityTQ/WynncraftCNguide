            ...
            activeType.value === "article"
                ? h("div", { class: "vp-star-article-wrapper" }, [
                    ...
                    stars.value.items.length
                        ? h("ul", { class: "vp-star-articles" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "vp-star-article" }, h(RouteLink, { to: path }, () => info[ArticleInfoType.title])))))
