...
export default class PageApi extends ApiBase {
    ...
    pv(): Promise<number>;
    /** 统计 */
    stat(type: 'latest_comments' | 'latest_pages' | 'pv_most_pages' | 'comment_most_pages' | 'page_pv' | 'site_pv' | 'page_comment' | 'site_comment', pageKeys?: string | string[], limit?: number): Promise<number | object | PageData[] | CommentData[]>;
}
