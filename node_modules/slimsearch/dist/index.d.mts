 ...
 */
declare const add: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, document: Document_1) => void;
/**
 ...
 */
declare const addAll: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, documents: readonly Document_1[]) => void;
/**
 ...
 */
declare const addAllAsync: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, documents: readonly Document_1[], options?: {
    chunkSize?: number;
}) => Promise<void>;
 ...
 */
declare const autoSuggest: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, queryString: string, options?: SearchOptions<ID, Index>) => Suggestion[];
 ...
 */
declare const has: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, id: ID) => boolean;
/**
 ...
 * @param id  The document ID
 */
declare const getStoredFields: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, id: ID) => Index | undefined;
 ...
 * ```
 */
declare const createIndex: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(options: SearchIndexOptions<ID, Document_1, Index>) => SearchIndex<ID, Document_1, Index>;
declare const loadIndex: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>({ index, documentCount, nextId, documentIds, fieldIds, fieldLength, averageFieldLength, storedFields, dirtCount, serializationVersion, }: IndexObject<Index>, options: SearchIndexOptions<ID, Document_1, Index>) => SearchIndex<ID, Document_1, Index>;
/**
 ...
 */
declare const loadJSONIndex: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(json: string, options: SearchIndexOptions<ID, Document_1, Index>) => SearchIndex<ID, Document_1, Index>;
 ...
 */
declare const search: <ID, Document_1, Index extends Record<string, any> = Partial<Document_1>>(searchIndex: SearchIndex<ID, Document_1, Index>, query: Query, searchOptions?: SearchOptions<ID, Index>) => SearchResult<ID, Index>[];
 ...
 */
declare const discard: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, id: ID) => void;
/**
 ...
 */
declare const discardAll: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, ids: readonly ID[]) => void;
/**
 ...
 */
declare const remove: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, document: Document_1) => void;
/**
 ...
 * documents.
 */
declare const removeAll: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, documents?: readonly Document_1[] | undefined) => void;
 ...
 * with
 */
declare const replace: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, updatedDocument: Document_1) => void;
 ...
 * {@link VacuumOptions}.
 */
declare const vacuum: <ID, Document_1, Index extends Record<string, any> = Record<never, never>>(searchIndex: SearchIndex<ID, Document_1, Index>, options?: VacuumOptions) => Promise<void>;

export { type AutoVacuumOptions, type BM25Params, type CombinationOperator, type IndexObject, type LogLevel, type LowercaseCombinationOperator, type MatchInfo, type Query, type QueryCombination, SearchIndex, type SearchIndexOptions, type SearchOptions, type SearchResult, SearchableMap, type SerializedIndexEntry, type Suggestion, type VacuumConditions, type VacuumOptions, WILDCARD, type Wildcard, add, addAll, addAllAsync, autoSuggest, createIndex, discard, discardAll, getDefaultValue, getStoredFields, has, loadIndex, loadJSONIndex, remove, removeAll, replace, search, vacuum };
