...
export { type Author, type AuthorInfo, type AuthorName, type BasePageFrontMatter, type CustomServerOptions, type DateDetail, type DateInfo, type DateOptions, type GetLocalesOptions, HTML_TAGS, type HopeLang, Logger, MATHML_TAGS, type PackageManager, type PageExcerptOptions, type RequiredLocaleConfig, SVG_TAGS, addChainWebpack, addCustomElement, addViteConfig, addViteOptimizeDepsExclude, addViteOptimizeDepsInclude, addViteSsrExternal, addViteSsrNoExternal, atou, checkVersion, compareDate, deepAssign, detectPackageManager, encodeCDATA, encodeXMLContent, endsWith, entries, fromEntries, getAuthor, getBundlerName, getCategory, getDateInfo, getDirContents, getLocalePaths, getLocales, getPageExcerpt, getPageText, getRealPath, getRootLang, getRootLangPath, getStringArray, getTag, getTitleFromFilename, getTypeofLockFile, hasGlobalInstallation, inferRouteLink, inferRoutePath, injectLocalizedDate, isAbsoluteUrl, isBoolean, isFunction, isNumber, isRegExp, isString, isUrl, keys, lang2Path, md2text, mergeAlias, mergeViteConfig, noopModule, path2Lang, startsWith, tagHint, timeTransformer, useCustomDevServer, utoa, values };
