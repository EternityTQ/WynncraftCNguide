...
同时，在开始任务前，最好在包内带绿宝石![=20x](/assets/icon/Emerald.png)(零散的)
...
+ Leni `[11614 51 7011]`(地上有绿色粒子效果,右键粒子效果放绿宝石![=20x](/assets/icon/Emerald.png)给Leni带路)
  
全部拉完后，对话然后进入工厂，走到最里面二楼

:::tip
这一步中，如果你没有绿宝石![=20x](/assets/icon/Emerald.png)，可以通过击杀周围的怪物来获取
:::
...
和<font color=00AA00>**Royal Advisor**</font>对话，然后走到贫民窟尽头绿宝石![=20x](/assets/icon/Emerald.png)块处安放炸弹，在限时内逃出来
...
PVP状态下拥有50%的采集经验值![=20x](/assets/icon/Experience_Orb.gif)加成和战斗经验值![=20x](/assets/icon/Experience_Orb.gif)加成
:::
