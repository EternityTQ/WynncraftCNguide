...
2.出来后一路直走，来到`[-1914 77 -4472]`的洞内，将拿到的钥匙丢入漏斗内
...
11.拿到shard后进入陨石内待命
从shard的刷新点往下走，来到`[-2432 13 -6395]`进去，会有一个不断闪现的墙，抓准时机进去

:::warning
拿到shard之后在流星区域class会导致身上的shard消失
