...
<span class="stage-index">11.</span> 进入黑市，走到最里面和黑市成员`[-97 154 -6046]`对话，想办法凑齐2000颗绿宝石![=20x](/assets/icon/Emerald.png)
:::tip 关于抬价
按这个数字找NPC：
50-200-300-200(和先前的同一个)-150-150

原理：每一个NPC的底价永远是1000绿宝石![=20x](/assets/icon/Emerald.png)

你可以找同一个NPC抬价两次，但是不能连续抬价

升价300绿宝石![=20x](/assets/icon/Emerald.png)的NPC只能找一次
