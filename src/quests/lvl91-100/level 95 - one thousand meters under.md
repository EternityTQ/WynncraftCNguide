...
<span class="stage-index">14.</span> 回潜艇 然后到底层控制室的另一侧，按下按钮进入最底层，在10秒内通过通道按下尽头的绿宝石![=20x](/assets/icon/Emerald.png)按钮
...
奖励
+ 5500000经验值![=20x](/assets/icon/Experience_Orb.gif)
+ 8192绿宝石![=20x](/assets/icon/Emerald.png)
+ Ominous Wind(项链)
+ 可以进入Void了
