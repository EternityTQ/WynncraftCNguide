...
你可以右键药水槽来删除不想要的治疗药水，比如买了超出当前等级的无法使用的药水就可以用这种方式来删除。当然你也可以直接扔掉。

+ 法力药水(Potion of Mana):在一定时间内恢复蓝量。数值特别高，基本可以看成持续时间内无限技能(大概)

+ 点数药水(Potion of Str/Dex...):临时增加技能点和对应的效果，注意这个额外增加的技能点并不能算作装备要求。
>其实技能点数值挺低的...效果也挺低，不如自制，总之别买

在任意副本门口也有Potion Merchant，但是只出售治疗药水和法力药水，且**价格非常贵**
