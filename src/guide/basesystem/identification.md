...
举个例子就是：-99%的TP cost只能让你连续进行1蓝耗的TP，从第三次开始就会开始叠加惩罚，变为6 11 16...

而-999 TP cost可以让你连续进行快两百次的1蓝耗TP

该词条存在最低蓝耗：1点。

特别地：Raid的Gambit（高血加蓝耗/20cost）的优先级在本词条之上。

而萨满的面具减蓝耗的优先级在本词条和Gambit之上，为最高优先级，所以你可以看到0点蓝耗，或者不完全受Gambit影响的情况。
