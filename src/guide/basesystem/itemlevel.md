...
+ **Normal(白色):** 俗称白装，箱子里很容易发现，同时怪物掉落白装的几率也很大
...
+ **Rare(粉装):** 与黄装特别相似，但是不同的是，大部分粉装已经被众人所熟知，换言之就是大伙都知道这玩意值钱了XD

但是还是比黄装稍微稀有一点！

+ **Set(套装):** 比较特殊的品质，套装品质一般来说单件强度不高，需要集齐套装内的其他装备一起穿戴才有强度

但是，玩家的配装一般不会怎么用到多件套装...

如果你在意套装属性，可以通过查询wiki来了解

+ **Legendary(蓝装):** 第三稀有的品质，大部分蓝装都拥有不错的属性，同时小部分还包含有Major ID(被动技能)

但是！还是那句话，并非品质好的就值钱(神话除外)，有部分蓝装因为过于泛滥且属性奇葩，因此价格还是要远远小于其他装备的

如果你希望卖装备赚钱，记得卖之前看看市场！

+ **Fabled(虚幻):** 虚幻品质的稀有度仅次于神话，绝大部分虚幻装备都拥有Major ID
