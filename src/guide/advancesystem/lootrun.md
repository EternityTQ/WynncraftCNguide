...
Radiant Hunter只需要Chance叠到10%以上，即可在每轮生成出充足的Radiant怪。

在选取挑战时，优先选择Defend，其次选择Slay，如果实在不行，也可以选择洞穴，但是**不进去开箱**，而是转头出去找Radiant野怪，这也一样算数，但是得挑战开始后才计数。

而Lights Out，反而是需要优先选择怪物少的洞穴，其次选择Defend，再不济选Destroy，而Slay一个都不要碰。

在Chance少的阶段，选择怪物少的洞穴会比较省事，进度加的较少。

而Defend，有个技巧是选择高攻速、有爆炸的武器(对我说的就是Warp)，在挑战开始时，一直平A仇恨在目标点上的怪物。
