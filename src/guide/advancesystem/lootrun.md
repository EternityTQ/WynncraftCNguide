...
=======
Lootrun的核心为获取Reward Pulls、Reward Reroll和Reward Sacrifice.
...
拿到橙色的目的是扩充信标选择，尽快获得Rainbow。

>当然，直接发你rainbow了你就收下

>如果你前四个挑战都没有橙，但是手头有每日加成/Sacrifice的奖励pulls，为了求稳可以直接投降

#### 挑战4-12
在完成第四个挑战后，你会获得一个任务。

但你首要任务不是完成它，而是先获得彩虹和增强的白信标挑战。

在你信标选择足够后，彩虹会自然出现。若你6选甚至7选都没出，可以直接reroll信标。

>可以尝试先拿青色，让彩虹翻倍

获得彩虹后，找青色+白色的组合。

若你脸黑无法获取，拿+12的红信标续命也行。但增强白后面也要尝试去拿
