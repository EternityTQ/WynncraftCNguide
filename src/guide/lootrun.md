...
| 绿色信标 | 获得120s的时间，且本轮怪物不会增加属性 | 无上限 |
...
| 灰色信标 | 和蓝色信标相同；第5轮开始才会出现；第20轮后消失 |
...
| Cleansing Ritual    | 每次完成挑战后，可以消费1个诅咒换取1个额外挑战轮数，上限为109轮                                              |
...
| Ultimate Sacrifice  | 获得1次最终奖励牺牲机会以及2次最终奖励刷新机会；每当计时器减少2min时，随机清除一个已有增益，从任意途径获得时间重置该倒计时       |
...
+ 阶段一：1~4轮
  ...
  接到第一个任务前，最好只吃蓝、橙，可能要做好一个boon都拿不到渡过阶段二的准备。

  同时，最佳情况是直接在阶段一吃到彩虹信标

  话说到底，阶段一一定要为后面做好铺垫，蓝信标能拿一个杀伤性上来就很强的最好

  比如说clockworker或者killstreak，能在前期就叠出非常优秀的数值

  这个阶段最好还要提高信标选数来撑过第二阶段
...
+ 阶段二：5~20轮
  ...
  想要在15轮内接取4个任务，你平均需要4轮完成一个。

  相对来说比较困难的阶段，同时你还需要将轮次叠到20轮以上，因此还需要同时吃到红信标
...
+ Cleansing Ritual ：T0级别任务，见到就拿，只要身上有诅咒就一定能拖到100轮

+ Materialism + Cleansing Greed：无条件清除紫信标负面作用

这两个任务组效果互斥，尽量别三个一起拿 (但是其实可以Cleansing Ritual + Materialism)

同时，以上任务组均可以搭配Equilibrium，形成非常强力的连招

你只需要分配2~3个任务给提高游戏体验即可

剩下的任务你可以选择分配给sac或rr来提高抽取神话的机会

**关于Gambling Beast**：Gambling Beast最好应该配合Stasis一起使用

同时，请不要无脑拿Gambling Beast

最好可以选择有curse条件的Gambling Beast，然后卡着不完成

期间一直往上叠剩余时间，直到叠到合适的时间后，再来完成Gambling Beast

这样你就可以有充足的rr数了

如果直接拿去Gambling Beast，收益反而很低
