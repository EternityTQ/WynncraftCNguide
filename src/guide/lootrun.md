...
同时，你也无法骑马，只能通过正常跑步进行跑步

这意味着，你唯一存放身上物品的方式是通过使用champion的宠物运送功能
:::
...
#### 信标思路
------------------
首先是最重要的事：蓝信标，或者说boon是你LR的核心所在
怪物的轮次增益非常恐怖，你如果拿不到足够的boon极其容易被滚雪球
(拿不到boon就打不过挑战、打不过挑战就拿不到boon)
因此你应当尽可能保证你的boon整体水平能超过怪物的属性

然后是，橙信标是非常重要的资源，可以说没有橙信标你就没法继续游戏
你应当保证你的信标选数在合适的及格线以上，防止一直不发你需要的信标！

接着对于紫信标和暗灰信标，如果你没有消诅咒的手段(任务)，那建议别拿！
诅咒如果不消去，会大幅提升难度，使得同样出现滚雪球的情况！

红绿信标可以用来拖回合，最好搭配使用，以免出现超时的现象。
...
对于新LR中，短途已经不吃香，最好能把轮次数叠到20+以上拿满任务，同时吃到大量的pulls

可以将整轮游戏分为3个阶段：

+ 阶段一：1~10轮
  
  在这个阶段，需要为阶段二做铺垫，同时可以的话请不要在彩虹前完成任务

  如果非要完成，请在下一次接灰信标前吃一个青信标以保证任务选数

  这个阶段你的主要目标是提高信标选数→获得彩虹信标→吃到青+白，同时你还需要铺好一定的boon

+ 阶段二：11~29轮

  这一阶段请不留余力地将重心放在完成任务上

  在灰信标消失轮次再次放宽后，这个阶段算是能比较安稳的完成

  
+ 阶段三： 30+轮

  能进入这个阶段一般来说已经顺利启动了(拿到了合适的任务)

  一般就是要想办法拖延回合数，拿到更多的pulls

  有两种增加回合数的办法：

  1.Cleansing Ritual任务，见到就拿，可以让你无条件拖到100轮上限

  2.红绿交替，非常坐牢，需要时刻注意不要浪费带时间的轮次数

  这个阶段如果你选了Cleansing Ritual，就可以不用信标选数，反之你需要考虑一下你的青红绿信标的情况：

  如果青红绿刷在同一轮，且下一轮一起消失，则你需要尽量降低你的信标选数，好打乱青红绿的规律

  如果青红/青绿刷在同一轮，且下一轮刷出绿/红，则你可以根据你想吃青+红还是青+绿来降低或保持信标选数

  如果青刷在同一轮，且下一轮刷出绿、红，则你应当尽量保持信标选数，以防止信标规律被打乱(这是最佳情况)
...
| <font color='AA00AA'> **Inner Peace** </font>         | **废，千万别拿**，当前版本有BUG，离线重登后会导致该任务效果失效|
