...
+ Mythic：一等奖，通常来说，一个奖池会有4-6件Mythic品质的物品，同时还可能刷新Insulator和Simulator(鉴定道具)。

+ Shiny Mythic：特等奖，与普通Mythic的区别就是多了一个独特的计数器以及只有自己才能看到的附魔特效。一个区域奖池只会有一件Shiny Mythic。

>根据民间统计，shiny mythic出率是普通神话的1/25

+ Liquid Emerald：奖池内通常会有1-2种10个以上le的奖品以及2-3种1-4个le的奖品，非赌狗开到大数目le基本可以收手了

+ Lootrun Tome：只有lr能够产出，通常包含一定数值的lb以及各元素伤害、防御等

+ Lootrun专属装备：只有lr最终奖励才能产出的装备，其中有些装备属性非常不错，还有待读者自行研究
