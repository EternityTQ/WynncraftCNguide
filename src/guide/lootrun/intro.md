...
:::tip 关于秒人伤害
radiant power高了之后，radiant怪经常出现秒人攻击。

根据changelogs的说法：

![2026/8/4 2:05](/assets/img/intro.md-08-16-09-40-08.png)

![2026/7/28 4:46](/assets/img/intro.md-08-16-09-40-20.png)

目前radiant怪存在两种极易致死的爆炸攻击，一种为技能形式的curse explosions，另一种为死亡触发的death explosions。

两者的攻击方式均为近战大额伤害

该伤害非常容易秒人，数值极高，有大量ehp也无济于事。在radiant power≥5的情况就需要避免接近radiant怪了，强烈推荐保持一定距离进行攻击。

例如法师选手可以在天上不停TP来进行攻击，目前实测只要保持距离，就绝对不会被秒杀。
