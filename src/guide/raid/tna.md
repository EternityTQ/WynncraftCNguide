...
:::tip 过关技巧
如果你身上装备有百分比减少普攻伤害的词条，请不要拿取果子，会对你的拆洞效率造成极大影响

同理，弓手的技能树中普攻倍率降低以及萨满基础普攻形态也会影响果子给予的伤害，所以走左路的弓手和萨满也请不要拿取果子
...
但是电粉主动的伤害是由最终普攻伤害的伤害决定的，因此普攻倍率降低也会影响到电粉主动，需留意
...
有且只有一名玩家需要通过传送门进入树内，在树中的各个房间内搜索，找到特殊的怪Interdimensional Isoptera
