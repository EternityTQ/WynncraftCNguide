...
> 🟥 The Watched
> 这是greg的标志性技能，在其血量降至66%和33%时触发。在此状态下，greg无法被攻击。所有玩家会被白色光束锁定两次，随后被一道火焰光束击中，引发爆炸。爆炸对8格内的玩家造成**25%最大生命值**的伤害，6格内的玩家额外受到**30%最大生命值**的伤害。此技能期间，虚空洞不会被清除，但技能结束后会立刻重置一次(也就是修地板)。
