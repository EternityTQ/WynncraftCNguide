...
- 场地周围时不时会出现黄金踏板可以将你送到塔顶。
- 每隔一段时间，场地四周的水晶下方会生成Decaying Parasite，如果在时间内没有将它们击杀，它们会使中央的塔Decay一段时间，处于Decay状态的塔无法站人。

![](/assets/img/nol2.png)

**关卡攻略建议**

1. 随时四处巡逻，不要放掉任何一只Parasite。
2. 有远程怪会去攻击塔上的玩家，塔上的玩家建议有些坦度或回血能力。
...
在30秒内击杀三只Crystalline Decay，并重复三次。

**关卡机制**
- 所有玩家自带+10跳跃高度。
- 从云朵上掉落会有5秒重生时间。
- Crystalline Decay即将出现的云朵上会有直立状的黑烟粒子(上图)。

**关卡攻略建议**
1. 虽然不会真的死，但还是尽量不要掉下云朵。
2. Crystalline Decay出现时旁边会伴随著多只小怪，它们都有击退玩家的能力，需注意。
3. Crystalline Decay本身的爆炸攻击很痛，需要注意。
...
击杀小王<mob>Athanatic Witness</mob>以获得2个`Light Crystal`。
...
1. Athanatic Witness有一定强度，注意它的攻击。
2. 遍布关卡各处的小怪Light也有一定强度，别掉以轻心。
3. 移速较慢的玩家不适合此跑酷。
4. 解谜的射击有时候会有点谜，但是能过就好
...
- 光柱(下图)会在场地各处随机移动。
- Crystal持有者需要持续待在光柱附近才可以推进关卡进度。
- 持有Crystal的玩家看不到光，需要其他三位玩家的指引。
- 如果持有Crystal的玩家死亡，Crystal将会掉落。

![光柱示例](/assets/img/nol7.png)

**关卡攻略建议**

1. 生存能力高的玩家建议优先拿Crystal。
...
跟著持有`Light Crystal`玩家的指引走过隐形迷宫，完成指定任务，来到终点。

![](/assets/img/nol9.png)

**关卡机制**
- 迷宫为随机生成，只有持有`Light Crystal`的玩家看得到路。
- 掉下去会回到起点并受到伤害。
- ::star:: Light Crystal持有者走一段路后会来到Checkpoint(黄金平台)，这时所有玩家都需要到Checkpoint集合。

![](/assets/img/nol10.png)

- ::star:: 在所有玩家到达Checkpoint后，之前的路径会生出最多两个铁平台，**持有Crystal的玩家要待在黄金平台上，而其余玩家需要回去站在铁平台上。所有铁平台上都至少需要有一位玩家站立。此步骤会需要重复两次，Checkpoint才会建立成功。**

![](/assets/img/nol11.png)

- 一共会需要建立三次的Checkpoint，最后一次是在终点前。

- 如果非持有Light Crystal的玩家有两位已死亡，铁平台只会出现一个

- 如果Light Crystal持有者死亡，整个队伍就必须从起点开始。

- 一共会需要建立三次的Checkpoint，最后一次是在终点前，完成即破关。

**关卡攻略建议**
1. 拿Light Crystal的玩家需要有一定的生存能力。
2. 不需要跟著Light Crystal持有者走迷宫，等到对方在Checkpoint停下来后再用位移技过去集合也可以
3. 第三次Checkpoint位置一定是在场地的彩色玻璃终点前，所以第二个Checkpoint建立后，就可以跳过迷宫直接到第三次Checkpoint的位置。
4. 此关卡怪物又多又烦，低ehp玩家需一直待在补师旁边。
5. 此关对Archer和Shaman可能不太友善。
