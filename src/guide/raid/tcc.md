...
:::tip 过关技巧
建议有回血能力的职业，或者有极高爆发输出的职业进行站台。

台上的小BOSS伤害极高，并且周围会刷新有远程能力的小怪，如果不能及时清掉，则很容易暴毙。

球法/血萨/Bolt/Trickster是比较合适的职业。
...
TCC的第三面固定为此综合挑战，玩家需要在守护<NPC>Astal</NPC>的同时，完成不同的挑战，解除四道符文封印
...
抵达存档点时，若不慎跌落可从起点快捷传送到存档点，存档点为队伍共享，一人抵达全队都可使用。
...
>
>应对方法：需要立即后撤到场地最后方，或者通过在扫到平台的一瞬间进行垂直位移进行规避(但是对时机把握要求很高)

>🟧 巨型拳击：Canyon Colossus会对竞技场某一区域的玩家进行拳击。
>
> 应对方法：该技能前摇为看向对应区域的玩家，躲开即可

>🟧 泰坦头槌：当玩家在范围内时，Canyon Colossus会用头撞击附近的所有玩家。
>
> 应对方法：尽量不要站在平台靠前的位置，否则巨像会使用这招，前摇较短可能不太能反应。
