...
## 制作
一般来说，在城镇中分布着各个制作副职的工作台，比如下图是药水制造的酿造台：

![每种制造业都有一个类似的工作台](/assets/img/prof4.jpg =300x400)

与其交互后即可打开制作界面(每种制作副职都有一样的界面！)
...
原料的星级会影响产物的耐久或者持续时间，而素材决定了产物的词条属性

素材分为0星，1星，2星，3星。越稀有的素材扣除的耐久、持续时间越多。

部分功能素材的不同摆放方式会为最后的成品带来不一样的效果。

使用更高稀有度的材料进行制作时，得到的经验更多

:::tip 当你在制作时不放置任何素材
+ 饰品：无任何属性
+ 武器：只有基础伤害
+ 防具：只有基础血量
+ 消耗品：作用和回血药水相当，且会**占用你的药水槽**<br>因为包满导致无法放置在药水槽的消耗品将会直接送至个人银行中，请留意
...
:::warning 自制物品都具有耐久限制！
自制物品在使用时均会掉落耐久，例如护甲在受击时、武器在攻击时。

当自制物品的耐久低于最大值的50%，会逐渐折损属性

耐久为0时只有10%的属性，**并不会直接消失**

使用修理碎片在铁匠处可以修复自制物品的耐久

**在修理耐久时，可以直接使用放置在银行内的修理碎片**
:::


:::tip
素材的等级限制表示其只能用于对应等级或者更高的配方中合成，
...
换句话说就是，你可以同时吃到这三者的BUFF，但是你不能同时吃同类消耗品BUFF

例如先吃一个药水，再吃一个药水，后者将会覆盖前者

但是先吃一个药水，后吃一个食物，两者可以共存

卷轴比较特殊，它可以将效果给予范围内的所有玩家

食物和药水都是单人使用，区别在于食物一般持续时间更长，但是效果较弱
