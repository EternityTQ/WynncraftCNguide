...
<p><strong>Selchar</strong>可以去往海上绝大部分岛屿，同时<strong>Llevigar</strong>和<strong>Nemract</strong>都可以坐船前往<strong>Selchar</strong></p>
<p><code v-pre>Climbing Helmet</code>是非常重要的任务物品，务必妥善保存，丢失了可以用/fixquests来找回</p>
</div>
</div></template>
