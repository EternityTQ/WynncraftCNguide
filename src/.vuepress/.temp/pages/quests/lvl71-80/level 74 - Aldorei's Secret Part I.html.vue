...
<p>然后在<code v-pre>[-493 112 -4438]</code>直接制作面包，记得在旁边购买水！</p>
</div>
<p>3.找到生锈的铁桶的用途</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>先在<code v-pre>[-510 125 -4377]</code>的瀑布这里打水</p>
<p>然后浇给路上的树苗就可以了</p>
</div>
<p>4.上来后，继续打水浇给旁边的树苗，进入现场</p>
<p>5.潜行通过，不要被守卫发现了！</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>开始的时候，进入右边的隧道</p>
<p>出来后往左走，沿着水流进入水底的隧道</p>
<p>然后继续往左走，经过树后进入粉色花的隧道</p>
<p>之后放任意技能打破玻璃，进入建筑物内</p>
</div>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>根据工厂内散落的残页，你需要找到如下原料：<br>
1个橙色底料<br>
2个黄色底料<br>
3个绿色底料<br>
4个紫色底料</p>
<p>然后带到<code v-pre>[-452 121 -4427]</code>的加工区添加进去就可以了</p>
<p>注意要手持才能添加，点太快会吞材料</p>
</div>
<p>11.喝下药水后，跟着地上的脚步痕迹走，来到二楼触发剧情</p>
<p>12.继续追击罪犯！</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<p class="hint-container-title">提示</p>
<p>如果你这么做了...</p>
<Tabs id="106" :data='[{"id":"放走Korben"},{"id":"举报Korben"}]'>
