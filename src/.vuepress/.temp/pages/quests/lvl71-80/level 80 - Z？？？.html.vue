...
<p>你只需要看每一对红-蓝之间的按钮数，即上面标粗的部分，然后操控你的蓝色方块<strong>向左移动</strong>，哪边中间按钮多，就把哪边中间的按钮降低至和另一边相同</p>
<p>换言之就是<strong>让红蓝对之间永远保持一致的间隔</strong></p>
<p>举个例子：</p>
<p>现在的情况是这样的：</p>
<table>
<thead>
...
<div class="hint-container danger">
<p class="hint-container-title">警告</p>
<p>阶段三必须刚刚好<strong>四名玩家</strong>才能完成</p>
<p>少于四名或多于四名都会被逐出场地</p>
</div>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>小趣事:在最后的白色陨石内，仍然有一些额外谜题，有兴趣可以自行尝试，可以单人解决，本攻略不会再列出这些谜题解法</p>
