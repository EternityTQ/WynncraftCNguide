...
<p><img src="/assets/img/lvl79-1.jpg" alt="" loading="lazy"><br>
...
<p>5.跟着有纸的道路, 到<code v-pre>[-175 39 -4676]</code>的房子里面找到房子地下室里的信封</p>
<div class="hint-container tip">
...
<li>1300000 经验</li>
<li>2048 绿宝石</li>
<li>可以使用Gawrick的实验性传送卷轴了</li>
</ul>
<div class="hint-container tip">
<p class="hint-container-title">如何使用Gawrick的实验性传送卷轴？</p>
<p>完成任务后你首先需要离开屋子</p>
<p>正常情况下，当你再次从屋子一楼进入二楼时，会传送至另一个房间</p>
<p>此时再和Gawrick对话就可以花费2EB使用传送</p>
<p>注意会随机传送到Gavel的某一个地方。</p>
</div>
</div></template>
