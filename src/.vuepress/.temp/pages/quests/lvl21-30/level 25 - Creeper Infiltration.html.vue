...
<p>虽然Creeper Mask不是Quest item，但是后续还有任务要再次回到这个洞穴，所以强烈建议至少留一个<code v-pre>Creeper Mask</code>在银行里</p>
<p>如果不慎丢失，你可以按此任务的2~5步骤重新拿到<code v-pre>creeper skin</code>和<code v-pre>pigman hide</code>然后再次兑换<code v-pre>Creeper Mask</code></p>
</div>
</div></template>
