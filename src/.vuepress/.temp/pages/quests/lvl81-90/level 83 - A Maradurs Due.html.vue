...
<p class="hint-container-title">你需要找到三个水晶碎片来逃离</p>
<p>其实就是分三个阶段。</p>
<p>阶段一：你会出生在一个封闭房间内，走到墙边就可以开启通道，随便走，通过跑酷就可以了</p>
<p>阶段二：你获得了一个水晶碎片，右键来切换黄紫方块的状态</p>
<p>当听到箱子打开的声音时，紫方块可以站<br>
