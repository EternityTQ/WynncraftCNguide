...
<p class="hint-container-title">如何撬锁？</p>
<p>需要完成三轮小游戏</p>
<p>开始后，当中间的title变为黄色时，手持牙签快速按下左键</p>
<p>很快就能做完</p>
</div>
<p>4.去矿井内的电梯触发剧情<code v-pre>[670 78 -4982]</code></p>
<p>5.沿着铁轨走，进入洞穴，使用手中的操纵杆操控矿车通过矿洞</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>左键操纵杆可以跳跃</p>
<p>右键操纵杆可以加速</p>
<p>空中长按右键可以滑翔</p>
<p>注意！在第二个存档点的时候有些点千万不要跳跃后接滑翔，大部分点都是跳跃后刚好能上去的，滑翔反而就寄了</p>
<p>这个地方有两个秘密记录</p>
<p>第一个在最开始的地方，往右跳有个铁轨</p>
<p>第二个在第一个大落点，掉下去后往后走就到了</p>
</div>
<p>6.拉下六个拉杆，逃离矿洞</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>在最开始的房间找到<code v-pre>Old Drill</code>和8个<code v-pre>Lit Torch</code></p>
...
<p>第六个在拉杆在tnt房间往左走，注意最后木地板看起来会断开，其实是往左前方拐了，要用tnt炸开</p>
<p><strong>在下方秘密记录的攻略中，前三个拉杆的顺序是你沿着木地板走找到拉杆的顺序</strong></p>
</div>
<div class="hint-container tip">
<p class="hint-container-title">关于秘密记录</p>
<p>这一阶段有六个秘密记录</p>
<p>第一个在最开始的房间的瀑布源头，上去就能看到</p>
<p>剩下的均需要挖掘圆石，从箱子里面开到</p>
<p>第二个在<code v-pre>[-14372 17 6146]</code>，在最开始的地方直挖就能找到</p>
<p>第三个在<code v-pre>[-14390 18 6146]</code>，沿着路找到tnt和打火石后，回到第二个拉杆处<code v-pre>[-14382 17 6147]</code>，在原木旁边放个tnt点燃，然后直接挖就能找到了</p>
<p>第四个在<code v-pre>[-14364 18 6133]</code>，在第三个拉杆处旁边炸开然后直接挖</p>
<p>第五个在<code v-pre>[-14393 18 -6121]</code>，在来到找到tnt的房间，沿着木地板往左走，直接直线挖到底，然后要连续用两个tnt炸开</p>
...
<p>然后整个过程也请尽量不要掉下悬崖，虽说会把你救上来，但是仍然可能出现bug让你上不去</p>
<p>笔者就这样被迫被吓了足足三次。</p>
</div>
<p>奖励</p>
<ul>
