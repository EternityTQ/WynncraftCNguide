<template><div><p>在城镇中，你可以找到许多功能性NPC，他们会帮助你的旅途过的更顺利。</p>
...
<p>Emerald Merchant能帮助你交换绿宝石(简称<code v-pre>e</code>)与绿宝石块(简称<code v-pre>eb</code>)，比例为<code v-pre>1eb=64e</code></p>
<figure><img src="/assets/img/bank1.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>银行能存储你的物品，并且还能随着战斗等级解锁购买更多页数的资格</p>
<figure><img src="/assets/img/bank4.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>银行分为账号公用以及角色专用</p>
<p>账号公用银行为全角色共享，但是角色银行之间不互通</p>
<p>灵魂绑定的物品仅可放置在角色专用的银行中</p>
<p>公用银行上限为21页，角色银行上限由rank决定，至高为10页</p>
<p>但是需要注意的是，购买的价格会随着页数的增长越来越贵，中后期可以想一下自己是不是真的需要额外的存储空间(因为实在是太贵了)</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>Emerald Merchant的标志是绿宝石</p>
<p>而Liquid Merchant的标志是LE</p>
<p>同时都有绿色地毯<br>
<img src="/assets/img/bank2.jpg" alt="" loading="lazy"></p>
</div>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>Powder Master的标志是高级雷粉+橙黄色地毯<br>
<img src="/assets/img/powder1.jpg" alt="" loading="lazy"></p>
</div>
<h2 id="blacksmith" tabindex="-1"><a class="header-anchor" href="#blacksmith" aria-hidden="true">#</a> Blacksmith</h2>
<p>铁匠一共有三种功能：</p>
<ol>
<li>出售装备：出售的价格可以简单理解为初始鉴定费用的总和的0.5~1.5倍。</li>
<li>分解装备：将装备分解为scrap，scrap可用于修复物品</li>
<li>修复物品：自制装备与采集工具均有耐久度，你可以用scrap来修复它们</li>
</ol>
<p>scrap还可以在玩家市场上购买</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>Blacksmith的标志是锤子<br>
<img src="/assets/img/blacksmith1.jpg" alt="" loading="lazy"></p>
</div>
<h2 id="potion-merchant" tabindex="-1"><a class="header-anchor" href="#potion-merchant" aria-hidden="true">#</a> Potion Merchant</h2>
<p>你可以在任意城镇中找到Potion merchant</p>
<p>Potion Merchant顾名思义，会出售各种各样的药水，同时药水等级和当前区域等级有关</p>
<ul>
<li>治疗药水(Potion of Healing):在一定时间内恢复生命值，同时有专属的堆叠药水槽。</li>
</ul>
<p>每次购买会给3瓶药，药水槽的上限为30瓶</p>
<p>你可以右键药水槽来删除不想要的治疗药水</p>
<ul>
<li>
<p>魔能药水(Potion of Mana):在一定时间内恢复蓝量。数值特别高，基本可以看成持续时间内无限技能(大概)</p>
</li>
<li>
<p>点数药水(Potion of Str/Dex...):临时增加技能点和对应的效果，注意这个额外增加的技能点并不能算作装备要求。</p>
</li>
</ul>
<blockquote>
<p>其实技能点数值挺低的...效果也挺低，不如自制，总之别买</p>
</blockquote>
<p>在任意副本门口也有Potion Merchant，但是只出售治疗药水和魔能药水，且<strong>价格非常贵</strong></p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>Potion Merchant的标志是治疗药水+红紫色地毯<br>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>Scroll Merchant的标志是白纸+白色地毯<br>
...
<p>因为存在感实在太低所以放在一起介绍了。</p>
<p>这两个商人会出售武器和防具，但是请注意<strong>仅限于过渡</strong></p>
<p>在没有合适的装备之前可以勉强用一用</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
