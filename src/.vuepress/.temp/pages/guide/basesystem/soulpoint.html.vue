...
<p>由于每个世界/线路的时间不是一致的</p>
<p>你可以通过切换至即将日出的服务器来快速恢复灵魂点数</p>
<p>重复此操作，你就可以在20分钟内恢复数点灵魂点</p>
</div>
<h2 id="灵魂点数的获得与丢失" tabindex="-1"><a class="header-anchor" href="#灵魂点数的获得与丢失" aria-hidden="true">#</a> 灵魂点数的获得与丢失</h2>
<p>每次死亡时，会降低2点灵魂点数；使用城镇传送卷轴时，会降低1点灵魂点数；创建/离开公会将会降低3点灵魂点数。</p>
<p>注意灵魂点数分存档，不公用。</p>
<p>在日出时，也就是每隔20分钟，你会恢复1点灵魂点数，注意这个也分存档，只恢复到你当前正在使用的存档。</p>
<p>对于离线时或者其他未在游玩的存档，每隔1个小时会恢复1点灵魂点数。</p>
<h2 id="灵魂点数上限" tabindex="-1"><a class="header-anchor" href="#灵魂点数上限" aria-hidden="true">#</a> 灵魂点数上限</h2>
<p>每隔15级战斗等级将会提升1点灵魂点数上限</p>
<p>也就是说，你将会在15、30、45、60、75级分别获得1点灵魂点数</p>
<p>并且在75级时达到15点上限</p>
</div></template>
