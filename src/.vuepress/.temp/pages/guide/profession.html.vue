...
<p>1级原材料制作出的物品根据自身的制作等级，分为1-3级，3-5级，5-7级，7-9级；<br>
具体等级根据范围内随机取值。</p>
<p>10级原材料则为10-13级，13-15级，15-17级，17-19级，20级往后以此类推。</p>
...
<div class="hint-container tip">
<p class="hint-container-title">如果你不放置任何素材...</p>
<ul>
<li>饰品：无任何属性</li>
<li>武器：只有基础伤害</li>
<li>防具：只有基础血量</li>
<li>消耗品：作用和回血药水相当，且会占用你的药水槽</li>
</ul>
</div>
<p>如果放了材料，则制作出来的物品带有材料属性</p>
<p>若消耗品放置了材料，则不再是回血功能，而是根据材料决定的属性</p>
<p>放置了材料的1-30级消耗品基础只能使用1次，31-70级2次，71级以上3次。</p>
<p>与此类似，1-30级自制武器装备只有1个粉槽，31-70级2个，71级以上3个。</p>
<div class="hint-container tip">
<p class="hint-container-title">自制物品都具有耐久限制！</p>
<p>自制装备受到攻击和移动时掉落耐久，自制饰品同理<br>
自制武器攻击和释放技能时掉落耐久。</p>
<p>当自制物品的耐久低于最大值的50%，会逐渐折损属性<br>
耐久为0时只有10%的属性，但是并不会直接消失</p>
<p>使用修理碎片在铁匠处可以修复自制物品的耐久</p>
<p><strong>修理碎片放置在银行也可以直接在铁匠处消耗。</strong></p>
</div>
<p>材料分为0星，1星，2星，3星。星级仅表示稀有度，不表示强度。</p>
<p>各种星级的材料都可能是比较实用的材料。</p>
...
<ul>
<li>武器（Weaponsmithing）：X锭+2X木头=长矛；2X锭+X木头=匕首</li>
<li>木工（Woodworking）：X木头+2X线=弓；2X木头+X线=法杖；X木头+2X鱼油=图腾</li>
<li>盔甲（Armoring）：X锭+2X纸张=头盔；2X锭+X纸张=胸甲</li>
<li>纺织（Tailoring）：X锭+2X线=靴子；2X锭+X线=护腿</li>
<li>饰品（Jeweling）：X宝石+X鱼油=指环；X宝石+2X鱼油=手镯；X宝石+3X鱼油=项链</li>
<li>炼药（Alchemism）：X鱼油+2X谷物=药水</li>
<li>卷轴（Scribing）：X鱼油+X纸张=卷轴</li>
<li>烹饪（Cooking）：X谷物+2X鱼肉=食物</li>
</ul>
<p>以上X的取值根据原材料等级取值</p>
<table>
<thead>
