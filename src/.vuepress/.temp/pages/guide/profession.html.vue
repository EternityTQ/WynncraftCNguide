...
<li>武器：只有基础伤害</li>
<li>防具：只有基础血量</li>
<li>消耗品：作用和回血药水相当，且会<strong>占用你的药水槽</strong><br>因为包满导致无法放置在药水槽的消耗品将会直接送至个人银行中，请留意</li>
</ul>
</div>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>不必因为实用素材全是扣耐久而添加加耐久的素材</p>
<p>实际上，正常来说，制造的时候大部分素材都是扣耐久的...</p>
<p>只有在特别极端的时候，才需要用到加耐久的素材(例如耐久实在不够用了)</p>
</div>
<div class="hint-container warning">
...
耐久为0时只有10%的属性，<strong>并不会直接消失</strong></p>
...
<p>例如一个96级材料，若用于制作93-95的物品，则无法使用该材料；</p>
<p>若用于制作95-97或者更高的等级，则可以使用。</p>
</div>
...
<div class="hint-container tip">
<p class="hint-container-title">药水、卷轴和食物分别有什么区别？</p>
<p>这三者其实都是消耗品，但是分别独立计算</p>
<p>换句话说就是，你可以同时吃到这三者的BUFF，但是你不能同时吃同类消耗品BUFF</p>
<p>例如先吃一个药水，再吃一个药水，后者将会覆盖前者</p>
<p>但是先吃一个药水，后吃一个食物，两者可以共存</p>
<p>卷轴比较特殊，它可以将效果给予范围内的所有玩家</p>
<p>食物和药水都是单人使用，区别在于食物一般持续时间更长，但是效果较弱</p>
</div>
