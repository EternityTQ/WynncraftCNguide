...
<blockquote>
<p>（本部分是在moe_block提供的1.20的Major id翻译文件的基础上整理，新增Major ID部分由tankofpacer进行翻译，由我进行整理及对部分过时内容进行更新，感谢他们的贡献）</p>
</blockquote>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>部分Major ID是随着2.0.3新版本的更新才加入的游戏，并且对应的装备武器只能通过新LR获取，所以你可能不会在游戏里经常看到这些Major ID</p>
</div>
<details class="hint-container details"><summary>Major ID 列表(非常非常长)</summary>
<p>（1）	Heart of the Pack 狼群之心<br>
效果：你的每四秒的回血量的35%转化为范围治疗，附近的队友获得该治疗量。<br>
物品：Ignis（95级神话弓）</p>
<p>（2）	Transcendance 超凡<br>
效果： 使用技能有50%的概率不消耗任何法力值。<br>
物品：Nirvana（97级神话匕首）</p>
<p>（3）	Roving Assassin 游斗刺客<br>
效果：隐身（刺客二技能）过程中，不会再锁定自身魔力恢复与生命恢复。<br>
物品：Weathered（96级神话匕首）</p>
<p>（4）	Cavalryman 骑术大师<br>
效果： 你现在可以骑马时使用普通攻击和技能，但是其造成的伤害会降低<br>
70%。<br>
物品：Galloping Spurs（40级虚幻靴子）</p>
<p>（5）	Cherry Bombs 樱桃炸弹<br>
效果： 你的烟雾弹（刺客四技能）技能现在接触目标后立刻爆炸，不再造成<br>
持续伤害，而是每颗立刻造成110%的伤害。<br>
物品：Conspirator's Trickpockets（78级虚幻护腿）；<br>
Blossom Haze（87级虚幻匕首）</p>
<p>（6） Entropy 熵能量<br>
效果：陨石（法师三技能）坠落速度翻三倍。<br>
物品：Lachesism（86级虚幻手镯）<br>
Violent-shift（77级虚幻靴子）</p>
<p>（7） Freerunner 自由疾跑<br>
效果：疾跑条小于30%时，疾跑速度翻倍。<br>
物品：Panic Attack（78级虚幻手镯）；Ornithopter（86级虚幻头盔）</p>
<p>（8） Greed 贪婪<br>
效果：拾起自然掉落的（被窃取属性或者击杀怪物触发掉落）绿宝石时，为<br>
自己和附近的队友恢复其最大生命值的15%。<br>
物品：The Jingling Jester（69级虚幻胸甲）<br>
Old Keeper’s Ring（82级传奇指环）<br>
The Exploited（100级传奇匕首）</p>
<p>（9） Guardian 守护者<br>
效果：附近所有队友受到的伤害的20%转为由你来承受，由这个效果转移来<br>
的伤害可以被你自己的敏捷点所闪避。<br>
物品：Guardian（93级神话长矛）</p>
<p>（10） Saviour’s Sacrifice 救世牺牲<br>
效果：当前生命值低于最大生命值50%时，自己和附近的队友获得20%的增伤<br>
和20%的免伤。<br>
物品：Hero（91级神话长矛）<br>
Eleventh hour（80级虚幻胸甲）</p>
<p>（11） Hawkeye 鹰眼<br>
效果： 将箭矢风暴收束为一道攻击，每支箭矢技能倍率为10%中性伤害，1%<br>
电属性伤害和1%气属性伤害。<br>
物品：Deadeye（45级虚幻弓）<br>
Nighthawk（93级虚幻头盔）</p>
<p>（12） Lightweight 轻盈<br>
效果：免疫摔落伤害。<br>
物品：Seven-League Boots（44级传奇靴子）<br>
Passus Lux（73级传奇靴子）<br>
Double Vision（79级虚幻手镯）<br>
Steamjet Walkers（86级传奇靴子）</p>
<p>（13） Madness 疯狂<br>
效果：每三秒随机释放一次普攻/本职业技能树中你已经学习的一个的技能（通过该方式释<br>
放的技能不消耗魔力，若释放的为位移技能，则一般来说不会触发，除非该位移技能有技<br>
能树加成），此效果触发的技能和普通攻击可以被Major ID: Sorcery（详见下方）<br>
所重复释放。<br>
物品：Pandemonium（99级传奇手镯）</p>
<p>（14） Magnet 磁力吸引<br>
效果：附近8格内的掉落物会被你吸引。<br>
物品：Vindicator（30级虚幻手镯）；Gravity（100级传奇胸甲）</p>
<p>（15） Plague 瘟疫蔓延<br>
效果：承受你的毒伤的怪物会将毒伤等额蔓延给附近的其他怪物。<br>
物品：Plague Staff（60级虚幻法杖）<br>
Uranium Aegis（77级虚幻胸甲）<br>
Cytotoxic Striders（99级虚幻靴子）</p>
<p>（16） Rally 集结<br>
效果：你的冲锋（战士二技能）技能不再造成任何伤害，但冲锋落地后，对<br>
你造成最大生命值10%的治疗，对附近队友造成其最大生命值15%的治疗。<br>
物品：Infernal Impulse（73级虚幻护腿）<br>
Rhythm of the Seasons（100级虚幻长矛）</p>
<p>（17） Sorcery 巫术施法<br>
效果：使用任何技能或者普通攻击后，30%的概率会无消耗地再触发一次效果。<br>
物品：Rewind（80级传奇匕首）<br>
Time Rift（95级虚幻胸甲）</p>
<p>（18）Taunt 嘲讽<br>
效果：使用战吼（战士四技能）后，附近12格内的怪物将会选择你作为攻击<br>
目标。<br>
物品：Strobelight（54级虚幻吊坠）<br>
Signal Flare（85级传奇靴子）</p>
<p>（19）Peaceful Effigy 和平图腾<br>
效果：图腾持续时间翻倍<br>
物品：Philosopher（36级虚幻护腿）<br>
Procrastination（86级传奇图腾）</p>
<p>（20） Furious Effigy 狂怒图腾<br>
效果：图腾持续时间减半，但是图腾的持续伤害和治疗频率翻倍<br>
物品：Tachypsychia（77级虚幻图腾）<br>
Panic Zealot（101级虚幻图腾）</p>
<p>（21） Flashfreeze 寒冰速冻<br>
效果：冰蛇（法师四技能）变为瞬间触发，且减速时间从4秒变成5秒，但<br>
是射程距离降低一半。<br>
物品：Heat Death（57级虚幻法杖）<br>
Impact Winter（66级虚幻护腿）<br>
Cold Wave（75级虚幻指环）</p>
<p>（22）Explosive Impact 爆炸之触<br>
效果：你的“附加爆炸”（Exploding）鉴定词条现在不仅会在使用普通攻击击<br>
杀目标后概率触发，也会在普通攻击命中目标后概率触发，概率等同于<br>
Exploding词条数值。<br>
物品：Scarlet Veil（54级虚幻头盔）</p>
<p>（23） Fission 崩裂瓦解<br>
效果：“附加爆炸”（Exploding）鉴定词条的效果触发后，其造成的伤害和范<br>
围变为两倍。<br>
物品：Hesperium（65级虚幻弓）<br>
Collapse （97级神话长矛）</p>
<p>（24） Geocentrism 地心光环<br>
效果：光环（萨满三技能）将以玩家自身为中心释放，且可以无需图腾直接<br>
释放。<br>
物品：Narcissist（92级虚幻图腾）</p>
<p>（25） Gravity well 重力吸引<br>
效果：陨石的范围提升，并将附近敌人向陨石的落点处拉扯。<br>
物品：Pure（65级神话法杖）</p>
<p>（26）Alterego   不完全觉醒<br>
效果：觉醒面具激活条件少40%，但是持续时间缩短25%<br>
物品：Apex（97级虚幻头盔）</p>
<p>（27） Soul eater   噬魂者<br>
效果：收割将会获得双倍的魔力，但是mark上限降低1<br>
物品：Ysengrim（101级虚幻匕首）<br>
Keeper of souls（91级虚幻胸甲）</p>
<p>（28） Juggle  狂野打击<br>
效果：Stronger Multihit 将会为multihit增加12次攻击而非3次，每次额外攻击的伤害降低10% 中性伤害<br>
物品：Roiling Ruckus（64级虚幻匕首）</p>
<p>（29） Divine honor   圣誉<br>
效果：Radiance的增幅效果提升至25%，但降低Bash 15% 的中性伤害<br>
物品：Veritas（98级虚幻长矛）<br>
Empyreal Emberplate（103级虚幻胸甲）</p>
<p>（30） Strings of fate   命运之弦<br>
效果：你召唤的puppets只能存在三秒，但其造成的所有伤害翻倍<br>
物品：Marionette（100级虚幻图腾）</p>
<p>（31） Escape route   逃脱计划<br>
效果：Frenzy/Time Dilation 的叠加层数变为双倍，最大上限减半<br>
物品：Tachyon（88级虚幻靴子）</p>
<p>（32）Reckless abandon  无谋冲锋<br>
效果：Tempset造成额外15% fire的伤害，并获得一次额外充能，战吼不再给予防御增幅<br>
物品：Anti-Causality（90级虚幻裤子）</p>
<p>（33） Overwhelm  压制<br>
效果：Bash额外攻击两次<br>
物品：Overreach（30级虚幻长矛）</p>
<p>（34） Perfect recall  绝佳回响<br>
效果：Memory Recollection会消耗全部150点mana bank来触发，且能额外     释放一个已释放的技能<br>
物品：Third wish（102级虚幻法杖）</p>
<p>（35） Forest’s blessing   森之祝福<br>
效果：增加所有的弓箭手召唤物(乌鸦/蛇/狼)的移速，攻速，视野范围，爆炸箭伤害降低30% 中性伤害<br>
物品：Briars' Embrace（99级虚幻弓）</p>
<p>（36） Gentle glow   柔光<br>
效果：治疗的回复量提升，对其他友方的恢复量额外提升，但恢复速度降低<br>
物品：Pyrrhic Respite（101级虚幻裤子）</p>
</details>
</div></template>
