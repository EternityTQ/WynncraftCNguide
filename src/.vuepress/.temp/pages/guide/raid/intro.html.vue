...
<p>每个raid的主流程均有四个关卡：三个从二选一的挑战中随机出现的一个挑战，以及最后的BOSS关。</p>
<p>每通过一个挑战，都可以在休息处从3个随机BUFF中选择获得1个BUFF，每个raid均有5种不同类型的buff。</p>
<p>休息处还布置有铁匠，你可以在这里修理你的自制装备。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>你可以直接在休息处使用<code v-pre>/kill</code>来回满血量</p>
</div>
<p>通过BOSS关之后，可以领取各个raid对应的奖励箱，其中会有绿宝石，符文(Nii,Uth,Tol)，三级以上的各类元素粉末，部分三星采集材料，以及各个raid的专属装备和Tome。</p>
<p>Raid中的死亡并不会丢失灵魂点，且您会在本关挑战完成时在休息处重生。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<div class="hint-container danger">
<p class="hint-container-title">警告</p>
<p>碍于wynncraft目前的屎诗级程序设计，尽管掉线重连是有概率可以回到游戏的，但是大部分情况下会出现很严重的BUG，包括但不限于挑战无法进行、游戏直接失败等等</p>
<p>因此，请尽量不要在挑战中途离线</p>
<p>在休息处掉线基本可以稳定重连回来，前提是队友都没进入下一个挑战</p>
</div>
<div class="hint-container tip">
...
<p>同时，RAID似乎还存在动态难度的说法，这一说法在notg上也似乎可以得到验证</p>
</div>
</div></template>
