<template><div><p><span style="font-size: 25px;"><strong>峡谷巨像</strong></span></p>
...
<p>请尽量避免使用低ehp的装备进行挑战（trickster除外）</p>
</div>
...
<h3 id="lava-lake" tabindex="-1"><a class="header-anchor" href="#lava-lake" aria-hidden="true">#</a> Lava lake</h3>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>如果你不熟悉机制或者在匹路人队，强烈建议不要随便去拿取翅膀</p>
<p>如果你找不到终点，可能会挨骂...</p>
</div>
...
<div class="hint-container danger">
<p class="hint-container-title">警告</p>
<p>这一挑战中，只要有两名及以上玩家阵亡，raid就会失败</p>
</div>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>说是30s，其实是绝对站不满时长的</p>
<p>一般来说要站三轮，也就是只要你保证每轮都能站20s以上，就是合格，否则也许应该反思一下谁出了问题...</p>
<p>这个挑战有两个很常见的bug：</p>
<p>一，如果两个玩家同时站上平台，有时会出现计算错误的情况，即三个玩家都站在平台上但是服务器显示只有两个玩家在平台上。遇到此类情况必须所有玩家都跳下平台之后重新站上去才可以继续挑战。</p>
<p>二，如果任意一个玩家进入一个通道然后离开，游戏自动判定这一回合失败并开始下一回合。</p>
</div>
<h2 id="room3" tabindex="-1"><a class="header-anchor" href="#room3" aria-hidden="true">#</a> Room3</h2>
<h3 id="statue" tabindex="-1"><a class="header-anchor" href="#statue" aria-hidden="true">#</a> Statue</h3>
<p>玩家会被传送至一个大空间内，空间的东南北三个方向各有一个雕像，雕像共有六点生命。</p>
<p>当玩家进入该场景，120s倒计时将会被激活，之后每隔10s，场地内会刷出大量敌怪，其中，僵尸外观的敌怪会攻击雕像，需要尽快解决。</p>
<p>如果任意雕像血量降低到0，则挑战<strong>重启</strong>并且僵尸数量从每个雕像一个变成每个雕像三个。</p>
<p>倒计时结束后，挑战通过</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>当前倒计时剩余时间&lt;=最低血量的雕像血量*10时，雕像是绝对安全的，请优先保证自己不要死亡。</p>
</div>
<h3 id="platform-1" tabindex="-1"><a class="header-anchor" href="#platform-1" aria-hidden="true">#</a> Platform</h3>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>在本关卡中，大陆玩家在山脚平台倒计时结束后，最终大门开启时，会出现非常严重的延迟，不用担心，这是正常现象(因为咸牛的马死了)</p>
<p>延迟时间受网络影响，因人而异，也有一说跟加速器有关</p>
<p>通常来说这个延迟发生的时候，已经通关了，所以影响不大，一般延迟结束的时候你就已经因为超时被自动传送进BUFF室了</p>
</div>
<p>玩家会被传送至一座山前，山脚下的路是被封住的，山顶上有一平台。</p>
<p>当有玩家踩在山顶平台上时，山下的通道会打开，山下内部也有一个平台。</p>
<p>山顶和山脚的平台各有60s的倒计时，当玩家站在中间3*3的浅蓝色范围时，倒计时才会启动</p>
<p>山下的倒计时用于开启山顶的通道，山顶的倒计时用于开启终点</p>
<p>两边倒计时均结束后，方可挑战成功。</p>
<p>需注意，周围会持续刷怪，平台每隔一段时间会启动防御模式，弹飞站在平台上的玩家，请保护好自己。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<p>这时候千万别停下来等延迟恢复，快按死后退键，说什么都别在嘴巴下面停着</p>
<p>如果你吃到了该技能，几乎是必死</p>
</div>
<p>巨像的嘴会根据玩家的攻击次数进行伤害反射，请额外注意这一点。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>如果你是以下类型的玩家，你可以在第二阶段结束后提前跳下平台，然后强行击杀巨像之嘴或巨像之脑：<br>
一，使用explosive impact的普攻玩家，并且拿到了两个以上的stonewalker<br>
二，使用trickster技能树并且技能点主要分布在地电水的刺客</p>
</div>
<p>在四个部分都被击败后，巨像脖子处的入口将会开启，在第二阶段内<strong>被标记的玩家</strong>需进入巨像内部完成解密</p>
<div class="hint-container danger">
<p class="hint-container-title">警告</p>
<p>第二阶段中被标记的玩家需要至少有一名在第三阶段结束前存活</p>
<p>若所有被标记的玩家均已死亡，则无人可以在巨像体内完成解密，意味着本局已经结束了。</p>
<p>死亡玩家无法进行解密</p>
</div>
