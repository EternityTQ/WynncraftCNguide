...
<p>下载地址：<a href="https://modrinth.com/mod/wynntils/" target="_blank" rel="noopener noreferrer">https://modrinth.com/mod/wynntils/<ExternalLinkIcon/></a></p>
...
<p>一个很像&quot;皇冠&quot;的图标实际上是Boss Altar</p>
</div>
<p>对准小地图任意方向按下<code v-pre>鼠标中键</code>，即为放置临时路径点</p>
<p>游戏中可从红色信标看到与该路径点的相对位置</p>
<div class="hint-container tip">
<p class="hint-container-title">分享临时路径点至聊天框</p>
<figure><img src="/assets/img/tils1.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>左键该按钮会将你的位置发送到公会频道</p>
<p>右键将会发送到队伍频道</p>
