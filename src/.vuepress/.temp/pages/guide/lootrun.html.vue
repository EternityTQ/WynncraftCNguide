...
<p><strong>无论何时，lr均是获取装备的重要来源</strong></p>
<p>本篇将会介绍新旧两种lr方式</p>
...
<p>其中，<code v-pre>Loot Quality</code>表示洞穴内箱子的质量(刷新时间)</p>
<p>而<code v-pre>Progress</code>表示当前洞穴的探索情况，若不是Completed(100%)，则代表洞穴内尚有未开启过的T3/T4箱子</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>这里的Loot Quality注意要和下文中提到的物品词条区分开来</p>
<p>一般来说，玩家群体间用的Loot Quality(简称lq)常指物品词条</p>
</div>
...
<p><code v-pre>Loot Quality</code>能提高箱子的物品质量，可以理解为提高神话的出率，同时还能开到更多传奇物品。</p>
<p>就现有的材料来说，你无法在100级前正常获得<code v-pre>Loot Quality</code>属性</p>
<h3 id="如何出发" tabindex="-1"><a class="header-anchor" href="#如何出发" aria-hidden="true">#</a> 如何出发？</h3>
<p>无论你多少级，你都可以开始lr</p>
<p>首先，最好有一个比较可观的<code v-pre>Loot Bouns</code>加成</p>
<p>你可以通过在市场上进行条件筛选来购买到合适的LB装备</p>
<figure><img src="/assets/img/lootrun6.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>部分lb装备可能会比较贵！</p>
</div>
<p>接着在你想进行lr的区域附近找一个城镇做好补给，比如购买充足的消耗品</p>
<p>然后就可以出发寻找箱子了！</p>
<p>记住你获得的装备要到鉴定师鉴定后才可以使用</p>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>计时器会在选择boon、选择任务、开启挑战最终宝箱时暂停计时</p>
</div>
...
<tr>
<td>灰色信标</td>
<td>和蓝色信标大致相同但青信标为选数翻倍；第5轮开始出现；第23轮后消失；任务进行时不会出现</td>
</tr>
<tr>
<td>红色信标</td>
...
<p>怪物抗性是非常恐怖的词条</p>
<p>会直接降低你造成的伤害(加算)</p>
<p>举个例子，当怪物抗性为84%时，你只能对他造成16%的伤害</p>
</div>
<h3 id="增益" tabindex="-1"><a class="header-anchor" href="#增益" aria-hidden="true">#</a> 增益</h3>
<p>在吃到蓝信标或者有任务加成的紫信标、暗灰信标后，你会受到增益(boon)</p>
<p>增益会给你带来不同属性的提升以帮助你更好完成接下来的挑战</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>如果你打算进行较多挑战轮数，一定要持有足够多的增益效果！</p>
...
<td>获得1次最终奖励牺牲机会以及2次最终奖励刷新机会；每当计时器减少2min时，随机清除一个已有增益，从任意途径获得时间延缓该倒计时</td>
</tr>
</tbody>
</table>
<div class="hint-container tip">
...
<p>新lr核心在于战斗能力，同时作为当前版本的endgame内容，强度十分高</p>
...
<li>
<p>阶段一：1~4轮</p>
<p>接到第一个任务前，最好只吃蓝、橙，可能要做好一个boon都拿不到渡过阶段二的准备。</p>
<p>同时，最佳情况是直接在阶段一吃到彩虹信标</p>
<p>话说到底，阶段一一定要为后面做好铺垫，蓝信标能拿一个杀伤性上来就很强的最好</p>
<p>比如说clockworker或者killstreak，能在前期就叠出非常优秀的数值</p>
<p>这个阶段最好还要提高信标选数来撑过第二阶段</p>
</li>
<li>
<p>阶段二：5~23轮</p>
<p>这一阶段请不留余力地将重心放在完成任务上</p>
<p>灰信标在23轮就会完全消失</p>
<p>想要在15轮内接取4个任务，你平均需要4轮完成一个。</p>
<p>相对来说比较困难的阶段，同时你还需要将轮次叠到20轮以上，因此还需要同时吃到红信标</p>
<p>这个阶段应该保持信标选数来防止信标演员</p>
</li>
<li>
<p>阶段三： 24+轮</p>
...
<p>这两个任务组效果互斥，尽量别三个一起拿 (但是其实可以Cleansing Ritual + Materialism)</p>
