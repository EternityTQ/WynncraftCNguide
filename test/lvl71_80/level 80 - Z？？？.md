...
# ??? (level 80)
<span style="font-size: 25px;"><span style="font-size: 25px;"><span style="font-size: 25px;"><span style="font-size: 25px;"><span style="font-size: 25px;">**来自疯狂科学家的解密挑战**</span></span></span></span></span>
:::warning 恐怖任务
本任务部分阶段内含跳吓
:::
...
:::
按照以下步骤做
1.进入`[-2084 77 -4473]`的洞内，在上面最顶层的脚手架找到钥匙

2.出来后一路直走，来到`[-1914 77 -4472]`的洞内，将拿到的钥匙丢入左侧的漏斗内，然后触发一下机关，在下面直到看到下面的洞有矿车经过
...
当三个人全部进入陨石内待命后，同时踩下陨石内的铁质压力板，即可传送至接取任务的地点
...
2.返回**Rooster Island**，通过捷径进入Lab N拿到生锈的钥匙
